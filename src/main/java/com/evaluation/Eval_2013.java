...
public class Eval_2013 {
	...
	public static void main(String args[]) {
		...
		// Load Student Answer
		String fileName = "src/main/java/com/answers/2013-Answer-01.txt";
		...
		rules.add(new String[] { "Theorem01.drl" });
		...
		rules.add(new String[] { "Theorem05.drl" });
		rules.add(new String[] { "Theorem12.drl" });
		rules.add(new String[] { "Theorem13.drl" });
		rules.add(new String[] { "Theorem14.drl" });
		rules.add(new String[] { "Theorem19.drl" });
		...
		SubQuestionXML subQuestionXML = markingSchemeParser
				.getMarkingScheme("src/main/java/com/markingSchemeParser/MarkingScheme_2013.xml").getQuestionXML()
